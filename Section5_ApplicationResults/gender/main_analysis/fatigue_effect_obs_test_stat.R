...
# Code for generating observed test statistic when computing p-value in Table 1 row 2 column 5
...
# Interested in task number as X
...
write.csv(obs_test_stat, "data/Table1/gender/fatigue_effect/obs_test_stat.csv")
