...
# Code for generating observed test statistic when computing p-value in Table 1 row 2 column 3
...
obs_test_stat = PO_stat(fit, idx_1, idx_2, respond_idx = 99:129)

write.csv(obs_test_stat, "data/Table1/gender/profile_order_effect/obs_test_stat.csv")
