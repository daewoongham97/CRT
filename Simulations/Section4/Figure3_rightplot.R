...
# Varying number of interactions
num_int = c(0, 6, 12, 18)
...
# Looping through number of interactions
int_signal = 0.06 # fixed interaction signal
...
file_name = paste0("data/Fig3_rightplot_results/pval", param_num, "_", loop_num, ".csv")
